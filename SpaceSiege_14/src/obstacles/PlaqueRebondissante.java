 ...
 */
public class PlaqueRebondissante implements Obstacles,  Serializable {
     ...
     */
    //Ahmad Khanafer
    public PlaqueRebondissante(double posX, double posY, double pixelsParMetre) {
    ...
    public PlaqueRebondissante(double posX, double posY, double largeur, double longueur , double rotation) {
